...
{dplyover} is an extension of {dplyr}, but it doesn't make use of (read: copy)
{dplyr} internals. This made it relatively easy to create this package without
copying internal dplyr functions and rewriting the major operating functions
(e.g. `mutate`, `summarise` etc.). However, this has some negative side effects
in terms of performance and compability.
