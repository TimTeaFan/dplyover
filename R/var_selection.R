...
#'   matched or replaced in the selected variable names.
#'
...
#'
#' * `cut_off()` Truncates variables names by`.pattern`.
#'
#' * `get_suffix()` Wrapper around `get_affix()` looking for invariant characters
#'   from the right side.
#'
#' * `get_prefix()` Wrapper around `get_affix()` looking for invariant characters
#'   from the left side.
#'
#' * ...
#'
