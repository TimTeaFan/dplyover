...
collapsing, recoding many variables in a similar way). 
...
and most of the tests for `dplyr::across` could be replicated successfully. 
...
`over`, I realized that its more general use case looks more like a `purrr::map`
...
By this I most defniitely introduced some bugs and edge cases which won't work, 
