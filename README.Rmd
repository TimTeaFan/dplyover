...
collapsing many variables in a similar way). 
...
### original function from dplyr on which dplyover is based:
...
Regarding compability, I have spent quite some time on testing the functionality
and most of the tests for `dplyr::across` could be reproduced successfully. 
